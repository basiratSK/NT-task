...
<body>
	<div id="container">
	<br>
	<div class="title text-center"><h2><label>Welcome <?php 
		echo $member_row['firstname']." ".$member_row['lastname'];?></label></h2>
	</div>
	...
	<div style="color:gray">
		<form method="post"> 
		<div>
			<textarea name="post_content" class="input" srows="7" cols="64" style="" placeholder=".........Write Someting........" required></textarea>
			<br>
		...
		<a style="text-decoration:none; float:right;" href="deletepost.php<?php echo '?id='.$id; ?>"><button class="btn btn-primary">Delete</button></a>
		
		<br><hr>
		<h5><i>Posted by: </i><a href="#"> <?php echo $posted_by; ?></a></h5>
		-
		...
		?>
		<br>
		<br><h4><?php echo $post_row['content']; ?></h4>
			<form method="post">
			<hr>
				<h6><label><i>Add your comment</i></label></h6><br>
				<input type="hidden" name="id" value="<?php echo $id; ?>">
				<textarea name="comment_content" class="input" rows="2" cols="44" style="" placeholder=".........Type your comment here........" required></textarea><br>
			...
			?>
			<br><a href="#"><?php echo $comment_by; ?></a> - <i><?php echo $comment_row['content']; ?></i></h5>
			<br>
			<?php				
